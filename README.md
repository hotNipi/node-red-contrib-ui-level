...
All four colors for stripes can be customized. In adition there is two color schemas. `Fixed sectors` - Colors tied to stripes according to sector values. `Value driven` - Single value based color for all active stripes.
